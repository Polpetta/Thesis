...
\paragraph*{Progettazione della struttura \glslink{serverless}{serverless}} La
progettazione di un'architettura di tipo \glslink{serverless}{serverless} ha
...
servizio offre un database flessibile di tipo \glslink{nosql}{NoSQL}, per tutti
...
\paragraph*{Integrazione con Messenger e Facebook}
